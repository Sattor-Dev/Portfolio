...
//########################################################################################################
    ...
    for (var i=0; i<height; i++){
        ...
        for(var a=0; a<width; a++){
          ...
          td.style.cursor = "url('./assets/images/ipaint/pen.png'),auto";
...
//#######################################################################################################
          ...
          for(let y=0;y<test.length;y++){
            ...
            function erase(){
              ...
              test[y].style.cursor = "url('./assets/images/ipaint/eraser.png'),auto";
            ...
            function unerase(){
              ...
              test[y].style.cursor = "url('./assets/images/ipaint/pen.png'),auto";
